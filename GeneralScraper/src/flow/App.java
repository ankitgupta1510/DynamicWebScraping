...
public class App {
    ...
    public static void main(String[] args) {
        ...
        // --- EXAMPLE 3: Policybazaar ko scrape karne ki KOSHISH ---
        // V.V. IMPORTANT NOTE: Policybazaar jaisi websites dynamic hoti hain.
        // Iska matlab hai ki data JavaScript se load hota hai.
        // Jsoup JavaScript nahi chala sakta, isliye ho sakta hai ki yeh scraper
        // data na nikal paye ya adhoora data nikale.
        // Yeh selectors bhi website ke badalne par change ho sakte hain.
        // Sahi selectors ke liye aapko website ko browser mein "Inspect" karna hoga.
        
        ScraperConfig policyBazaarConfig = new ScraperConfig(
            "https://www.policybazaar.com/health-insurance/health-insurance-india/",
            "div.ci-plan-card__container" // Har plan ke card ka container (Educated Guess)
        );
        policyBazaarConfig.addDataPoint("Insurance Plan Name", "p.ci-plan-card__planName");
        policyBazaarConfig.addDataPoint("Premium", "span.ci-plan-card__premiumStartingPrice--value");
        
        System.out.println("--- Starting Scraper for Policybazaar.com ---");
        String scrapedPolicies = scraper.scrape(policyBazaarConfig);
        System.out.println("\n--- SCRAPED POLICIES ---");
