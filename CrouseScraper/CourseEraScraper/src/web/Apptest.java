    ...
    public static void main(String[] args) throws IOException, InterruptedException {
    	 String url = "https://www.coursera.org/graphql-gateway?opname=Search";
            ...
            while (true) {
                ...
                int coursesFound = parser.parseAndSaveData(res.body(), saver);

                if (coursesFound == 0) {
                    System.out.println("No more courses found. Ending scrape.");
                    break;
                }
            ...
            saver.closeFile(); 
            System.out.println("Scraping complete! Data saved to coursera_courses.csv");
        }
}
