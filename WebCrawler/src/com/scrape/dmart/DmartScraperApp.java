...
public class DmartScraperApp {
    public static void main(String[] args) {
        try {
            ...
            List<ProductData> allProds = new ArrayList<ProductData>();
    ...
    private static List<String> fetchAllCatToken() throws IOException {
        List<String> seoToken = new ArrayList<String>();

        String res = Jsoup.connect("https://digital.dmart.in/api/v1/categories/@top?profile=details&storeId=10151")
                .ignoreContentType(true).header("Accept", "application/json, text/plain, */*").userAgent("Mozilla/5.0")
                .execute().body();
