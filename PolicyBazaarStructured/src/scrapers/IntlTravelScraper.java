...
import models.InternationalTravelPolicy;

public class IntlTravelScraper implements InsuranceScraper{
	public List<InternationalTravelPolicy> scrape() {
        System.out.println("\n--- Starting Travel Insurance Scraping ---");
        List<InternationalTravelPolicy> policies = new ArrayList<>();
        ...
        for(int i=0;i<3;i++) {
        	...
        	String travelPayload = 
             	    "{\"task\":\"topplans_v2\",\"pagename\":\"USA\",\"planfor\":\""
             	    + loadVariable
             	    + "\","
             	  + "\"destination\":\"262\",\"currencyID\":\"1\",\"supplierid\":\"0\","
             	  + "\"sumInsured\":\"50000\",\"tripDays\":\"180\"}";
        	
        	System.out.println(travelPayload );
            ...
            try {
                ...
                for (Element plan : plans) {
                    policies.add(new InternationalTravelPolicy(
                    		category,
                ...
                System.out.println("Successfully scraped " + policies.size() + " International Travel Insurance policies.");
            } catch (Exception e) {
                System.err.println("Error scraping International Travel Insurance: " + e.getMessage());
            }
    ...
    public String getSheetName() {
        return "International Travel Insurance";
    }
